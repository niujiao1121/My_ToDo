...
可视化 GitHub Issues 的树状结构，显示任务的优先级、截止日期和从属关系。
...
└── ◯ #10 [PROJECT] 博客系统开发 (📦 项目, 🟠重要, ⏰2024-12-31)
    ├── ◯ #15 [TASK] 用户认证系统 (⏰ 有期限, 🟠重要, ⏰2024-12-25)
    │   ├── ✓ #20 [SUBTASK] 实现用户注册 API (📌 子任务, 🟡中等)
    │   └── ◯ #21 [SUBTASK] 实现用户登录 API (📌 子任务, 🟡中等)
    └── ◯ #16 [TASK] 文章管理功能 (⏰ 有期限, 🟡中等, ⏰2024-12-30)

📋 独立任务列表
--------------------------------------------------------------------------------
├── ◯ #5 [TASK] 学习 Docker (🔓 开放性, 🟡中等)
└── ✓ #3 [TASK] 完成周报 (⏰ 有期限, 🟡中等)
